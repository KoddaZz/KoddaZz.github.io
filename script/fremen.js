...
changeThemeBoutton.addEventListener('click', () => {
  ...
  if (styleLink.getAttribute('href') === 'css/fremen.css') {
    styleLink.setAttribute('href', 'css/BRIGHT_fremen.css'); // Basculer vers le thème clair
  } else {
    styleLink.setAttribute('href', 'css/fremen.css'); // Revenir au thème sombre
  }
});